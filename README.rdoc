...
My suggest is to use this project like a black box library. If your system uses other types of card or game flow, the best way is encapsulate this implementation in an Adapter, Decorator, Proxy or other design patterns 
...
=== Check out the following example
	...
	game.newGame(new Deck(), homer, flanders);
	game.deal();
	game.callFlop();
	game.betRiver();
	game.betTurn();
	...
	//IPlayer.getRankingEnum() can be changed in deal, call flop, bet river and bet turn steps
...
* COUNT = how many times the same ranking winner name occurs
